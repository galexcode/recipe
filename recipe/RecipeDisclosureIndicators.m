...
@implementation RecipeDisclosureIndicators
...
{
	RecipeDisclosureIndicators *ret = [[RecipeDisclosureIndicators alloc] initWithFrame:CGRectMake(0, 0, 11.0, 15.0)];
